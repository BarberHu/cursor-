...
class QuestionClassifier:
    def __init__(self):
        ...
        # 使用os.path.join()构建正确的文件路径
        self.disease_path = os.path.join(current_dir, 'dict', 'disease.txt')
        self.department_path = os.path.join(current_dir, 'dict', 'department.txt')
        self.check_path = os.path.join(current_dir, 'dict', 'check.txt')
        self.drug_path = os.path.join(current_dir, 'dict', 'drug.txt')
        self.food_path = os.path.join(current_dir, 'dict', 'food.txt')
        self.producer_path = os.path.join(current_dir, 'dict', 'producer.txt')
        self.symptom_path = os.path.join(current_dir, 'dict', 'symptom.txt')
        self.deny_path = os.path.join(current_dir, 'dict', 'deny.txt')
        # 加载特征词
